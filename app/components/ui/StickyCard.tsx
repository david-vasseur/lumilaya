...
function StickyCard({
  ...
  image,
    ...
    return (
        <div className="sticky-card relative h-svh w-full bg-linear-to-br from-[#FDFBF7] via-[#F9F6F0] to-[#F5F1EB] flex items-center justify-center will-change-transform">
      <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">

        {/* LEFT */}
        <div className="lg:col-span-7 space-y-6 lg:space-y-8 pt-20 lg:pt-0">
