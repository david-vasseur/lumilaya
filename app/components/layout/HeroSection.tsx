	...
	return (
		<section ref={heroRef} className="relative h-screen overflow-hidden">
			...
			<div ref={imageRef} className="absolute inset-0">
				{isMobile ? (
					<Image src={"/images/landing/mobile-hero2.webp"} fill alt='' className="object-cover" />
				) : (
					<Image 
			...
			/>
			{/* Contenu principal */}
			<div ref={contentRef} className={`relative h-full flex items-start md:items-center justify-center z-10 ${isMobile ? "translate-x-0!" : "-translate-x-25"}`}>
